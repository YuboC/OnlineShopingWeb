...
//
//    @RequestMapping( value = "/creatives/{accountId}/{buyerCreativeId}/addDeal/{dealId}", Method = GET)
//    public Pet findPet(@PathVariable int accountId, @PathVariable String buyerCreativeId, @PathVariable long dealId) {
//    ...
//    }
